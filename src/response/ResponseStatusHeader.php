...
readonly class ResponseStatusHeader implements Stringable
{
    public function __construct(
        public float $version,
        public InfoCodes|SuccessCodes|RedirectCodes|ClientErrorCodes|ServerErrorCodes $code,
    ) {
    }
    ...
    public function __toString(): string
    {
        return sprintf(
            ...
            $this->version,
            $this->code->value,
            StatusCodeMessageMapper::forCode($this->code)->value,
        );
    }
}
